...
const services = [
  {
    ...
    description: 'Innovative mechanical design and precision engineering solutions.',
    icon: '⚙️',
  },
  {
    name: 'Aerospace',
    description: 'Cutting-edge aerospace and aviation engineering services.',
    icon: '🛩️',
  },
  {
    name: 'Automotive',
    description: 'Advanced automotive systems and vehicle technology development.',
    icon: '🚗',
  },
  {
    name: 'Defense',
    description: 'Strategic defense systems and military technology solutions.',
    icon: '🛡️',
  },
  {
    name: 'Energy Systems',
    description: 'Sustainable energy solutions and power system engineering.',
    icon: '⚡',
  },
  {
    name: 'Systems Integration',
    description: 'Seamless integration of complex engineering systems.',
    icon: '🔄',
  },
];

const technologies = [
  'CAD/CAM', 'FEA Analysis', 'CFD Simulation',
  'Robotics', 'Control Systems', 'IoT Integration',
  'Prototyping', '3D Printing', 'Materials Science',
  'Automation', 'Mechatronics', 'Quality Control',
];
