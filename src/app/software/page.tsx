      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-[84rem] px-6 py-32 sm:py-40 lg:px-8">
          ...
          >
            ...
            >
              Building innovative software solutions that power the digital transformation of businesses and industries.
            </motion.p>
            <motion.div 
              variants={fadeInUp}
      ...
      <div className="mx-auto max-w-[84rem] px-6 py-32 sm:py-40 lg:px-8">
        <div className="relative mx-auto max-w-2xl text-center">
          ...
          <p className="relative mx-auto mt-8 max-w-2xl text-xl leading-8 text-gray-300">
            Let's build innovative software solutions that drive your business forward.
          </p>
