    ...
    <div className="bg-white dark:bg-[#17171C]">
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-[84rem] px-6 py-32 sm:py-40 lg:px-8">
          ...
          >
            ...
            >
              Exploring the frontiers of technology through innovative research and experimentation.
            </motion.p>
            <motion.div 
              variants={slideUp}
      ...
      <div className="mx-auto max-w-[84rem] px-6 py-24 sm:py-32 lg:px-8">
        ...
        >
          ...
          >
            We conduct cutting-edge research and develop innovative solutions for tomorrow's challenges.
          </motion.p>
        </motion.div>
      ...
      <div className="mx-auto max-w-[84rem] px-6 py-32 sm:py-40 lg:px-8">
        ...
        >
          ...
          <motion.p 
            ...
            className="mt-8 text-xl leading-8 text-gray-600 dark:text-gray-300"
          >
            We explore and experiment with emerging technologies and research methodologies.
          </motion.p>
        </motion.div>
      ...
      <div className="mx-auto max-w-[84rem] px-6 py-32 sm:py-40 lg:px-8">
        ...
        >
          ...
          >
            Let's push the boundaries of what's possible through innovative research and development.
          </motion.p>
          <motion.div 
            variants={slideUp}
