...
export default function Blog() {
  ...
  return (
    <div className="bg-white dark:bg-[#17171C] py-24 sm:py-32">
        ...
        >
          <article className="flex flex-col items-start">
            <div className="relative w-full">
              <div className="absolute -inset-y-6 -inset-x-4 z-0 scale-95 bg-gray-50 dark:bg-[#1F1F28] opacity-0 transition group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl" />
