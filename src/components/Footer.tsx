  ...
  return (
    <footer className="bg-white dark:bg-[#0A0A0C] border-t border-gray-200 dark:border-amber-600/10" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-amber-500 dark:text-amber-400">Divisions</h3>
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm font-semibold leading-6 text-amber-500 dark:text-amber-400">Company</h3>
                <ul role="list" className="mt-6 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-amber-500 dark:text-amber-400">Legal</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="mt-16 border-t border-gray-200 dark:border-amber-600/10 pt-8 sm:mt-20 lg:mt-24">
